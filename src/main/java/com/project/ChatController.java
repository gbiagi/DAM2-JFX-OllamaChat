...
public class ChatController implements Initializable {
    ...
    // Add hover effect
//        roundedButton.setOnMouseEntered(e -> roundedButton.setStyle("-fx-background-radius: 30; -fx-border-radius: 30; -fx-padding: 10 20; -fx-background-color: #2980b9; -fx-text-fill: white;"));
//        roundedButton.setOnMouseExited(e -> roundedButton.setStyle("-fx-background-radius: 30; -fx-border-radius: 30; -fx-padding: 10 20; -fx-background-color: #3498db; -fx-text-fill: white;"));
    //roundedButton.setGraphic(imageView);
//
//
//    @FXML
